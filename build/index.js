...
class FileSystemServer {
    ...
    async handleSearchFiles(directory, pattern) {
        try {
    ...
    async run() {
        ...
        if (port) {
            ...
            app.use((req, res, next) => {
                ...
                const requestKey = authHeader?.replace("Bearer ", "") || req.query.key;
            ...
            app.listen(port, () => {
                ...
                if (apiKey)
                    ...
                    console.error("WARNING: No API key set, server is open to public!");
            });
        }
        else {
            // Stdio Mode
